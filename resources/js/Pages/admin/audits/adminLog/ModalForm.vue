        ...
        <template v-slot:content>
            ...
            <section class="p-5 border border-slate-300 rounded mt-5">
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <div>
                        <div class="font-medium text-sm text-slate-600 mb-1">Old Values</div>
                        <div class="font-normal text-sm text-slate-500 bg-neutral-900 !text-white p-2 rounded-md">{{ data.old_values }}</div>
                    </div>
                    <div>
                        <div class="font-medium text-sm text-slate-600 mb-1">New Values</div>
                        <div class="font-normal text-sm text-slate-500 bg-neutral-900 !text-white p-2 rounded-md">{{ data.new_values }}</div>
                    </div>
                </div>
            </section>
        </template>
